...
bench_llvm_argp.ll: gen_ff.py
	$(PYTHON) gen_ff.py -u 64 -type $(TYPE) -pre llvm_argp_ -mul -arg-p > $@
...
bench_llvm_var.o: bench_llvm_var.ll
	$(CLANG) -c -o $@ $< $(CFLAGS)
bench_llvm_argp.o: bench_llvm_argp.ll
	$(CLANG) -c -o $@ $< $(CFLAGS)
bench_x64.o: bench_x64.S
	$(CXX) -c -o $@ $< -fPIC
$(BENCH_EXE): misc/bench.cpp bench_llvm.o bench_llvm_var.o bench_llvm_argp.o bench_x64.o
	$(CXX) -o $@ $< bench_llvm.o bench_llvm_var.o bench_llvm_argp.o bench_x64.o $(CFLAGS)
bench: $(BENCH_EXE)
	./$(BENCH_EXE)
